                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h1 class="page-header">
                            ...
                            $the_post_author_title=$_GET['author'];
                            echo "Displaying all posts by ".$the_post_author_title;
                  ...
                  $query="SELECT * FROM posts WHERE post_author='{$the_post_author}' && post_status='published'";
